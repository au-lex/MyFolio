            ...
            <div className="flex items-center gap-4 pt-4 border-t border-border">
              ...
              {project.liveLink && (
                <a
                  ...
                  className="flex items-center justify-center w-12 h-10 border border-border hover:border-purple-500 text-sec hover:text-purple-500 transition-all rounded-sm bg-card s"
                >
