  ...
  return (
    <Layout>
      ...
      >
        ...
        <div className="relative w-full h-[50vh] lg:h-[60vh] overflow-hidden bg-zinc-900 border-b border-zinc-800">
            ...
            <div className="absolute bottom-0 left-0 w-full p-6 lg:p-12 max-w-7xl mx-auto z-10">
                ...
                >
                    <div className="w-8 h-8 border border-zinc-700 rounded-full flex items-center justify-center group-hover:border-white group-hover:bg-white group-hover:text-black transition-all">
                        <ArrowLeft size={14} />
                    </div>
                    Back to Archive
                </motion.button>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 mt-16 lg:mt-24">
            ...
            <div className="lg:col-span-8 space-y-20">
                ...
                <section>
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="text-zinc-500 font-mono text-sm tracking-widest uppercase">01 // The Challenge</h3>
                    </div>
                ...
                <section>
                    <div className="flex items-center gap-3 mb-6">
                        <span className="w-12 h-[1px] bg-purple-500"></span>
                        <h3 className="text-zinc-500 font-mono text-sm tracking-widest uppercase">02 // The Engineering</h3>
                    </div>
                    <p className="text-zinc-300 text-lg md:text-xl leading-loose whitespace-pre-line font-light">
                        {project.solution}
                    </p>
                ...
                <section>
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <h3 className="text-zinc-500 font-mono text-sm tracking-widest uppercase">03 // Interface Gallery</h3>
                    </div>
                    
                    <div className="grid grid-cols-1 gap-8">
                        {project.gallery.map((img, index) => (
                            <div key={index} className="group relative rounded-sm overflow-hidden border border-zinc-800 bg-zinc-900">
            ...
            <div className="lg:col-span-4 space-y-12 h-fit lg:sticky lg:top-12">
                ...
                {/* Quick Info Box */}
                <div className="p-8 border border-zinc-800 bg-zinc-900/30 backdrop-blur-sm rounded-sm space-y-8">
                    <div className="space-y-6">
                        <div className="border-b border-zinc-800 pb-4">
                            <span className="block text-[10px] font-bold text-purple-500 uppercase tracking-widest mb-2">Role</span>
                            <span className="text-white text-lg font-medium">{project.role}</span>
                        </div>
                        <div className="border-b border-zinc-800 pb-4">
                            <span className="block text-[10px] font-bold text-purple-500 uppercase tracking-widest mb-2">Timeline</span>
                            <span className="text-white text-lg font-medium">{project.timeline}</span>
                        </div>
                        <div className="pb-2">
                            <span className="block text-[10px] font-bold text-purple-500 uppercase tracking-widest mb-2">Client</span>
                    ...
                    <div className="flex flex-col gap-3 pt-2">
                        {project.liveLink && (
                             ...
                             >
                                Launch Project <ExportSquare size={16} variant="Bold" />
                             </a>
                        )}
                        {project.repoLink && (
                            <a 
                ...
                {/* Tech Stack */}
                <div>
                    <h3 className="text-zinc-500 font-mono text-xs tracking-widest uppercase mb-6 border-b border-zinc-800 pb-2">Technical Stack</h3>
                ...
                {/* Key Features List */}
                <div>
                    <h3 className="text-zinc-500 font-mono text-xs tracking-widest uppercase mb-6 border-b border-zinc-800 pb-2">Key Features</h3>
                    <ul className="space-y-4">
                        {project.features.map((feature, i) => (
                            <li key={i} className="flex items-start gap-3 text-sm text-zinc-300 leading-relaxed group">
                                <span className="text-purple-500 mt-[6px] text-[10px]">■</span>
