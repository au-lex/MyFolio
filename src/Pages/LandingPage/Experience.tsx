  ...
  return (
    ...
    <section className="text-text transition-colors duration-300">
      <div className="mx-auto">
        ...
        {/* --- SHARP HEADER --- */}
        {/* Updated: border-zinc-800 references -> border-border */}
        <div className="mb-16 border-l-2 border-purple-500 pl-6 py-2">
          <div className="flex items-center gap-3 mb-2">
            <Briefcase size={24} variant="Bold" className="text-purple-500" />
            <h2 className="text-3xl font-black uppercase tracking-tighter">Career_Log</h2>
          </div>
          ...
          {experienceData.map((item, index) => (
            <div key={item.id} className="group relative flex gap-6 md:gap-10 pb-12 last:pb-0">
              ...
              <div className="flex flex-col items-center">
                 {/* Node - Updated: bg-zinc-950 -> bg-pri, border-zinc-700 -> border-border */}
                 <div className={`
                 ...
                 {/* Connecting Line - Updated: bg-zinc-800 -> bg-border */}
              ...
              <div className="flex-1 -mt-2">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-2">
                    <div className="flex items-center gap-3">
                        {/* Date Badge - Updated: border-zinc-800 -> border-border, bg-zinc-900 -> bg-sec/10 */}
                        <span className={`
                ...
                {/* Main Card - Updated: bg-card, border-border, hover:bg-sec/5 */}
                <div className="relative group/card bg-card border border-border p-6 sm:p-8 hover:bg-sec/5 hover:border-purple-500/50 transition-all duration-300 rounded-sm shadow-sm">
