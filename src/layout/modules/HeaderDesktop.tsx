    ...
    <header className="hidden xl:flex h-24 border-b border-border items-center justify-between px-8 sticky top-0 bg-pri/80 backdrop-blur-md z-10 transition-colors duration-300">
        ...
        <div className="flex items-center gap-6">
            <div className="flex items-center gap-4">
                ...
                <div className="bg-card border border-border px-4 py-2 rounded-lg font-mono text-text text-sm shadow-sm">
                    01:59:45
                </div>
            </div>
            ...
            <button 
                ...
                className="w-10 h-10 flex items-center justify-center rounded-lg border border-border bg-card text-sec hover:text-purple-500 hover:border-purple-500 transition-all shadow-sm"
                title="Toggle Theme"
            >
                {isDarkMode ? (
